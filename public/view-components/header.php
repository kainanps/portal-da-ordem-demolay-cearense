...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../public/css/estilo-artigo.css">
            ...
            <div class="modal">
                <div class="form">
                    ...
                    <div>
                        ...
                        <input type="submit" value="Entrar" class="entrar" id="entrarLeft">
                    </div>
                </div>
            </div>
        </div>
...
?>
    <div class="container">
        ...
        <nav class="barra2">
            ...
            <ul class="menu">
                <a href="../"><li class="aba flutuar">Início</li></a>
